...
.method public declared-synchronized deleteOldest(Landroid/database/sqlite/SQLiteDatabase;I)Z
    ...
    const-string/jumbo v4, "delete oldest: escape="
    ...
    const-string/jumbo v0, "Delete oldest exception!"
...
.method public declared-synchronized deleteRecordsById(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/List;)Z
    ...
    const-string/jumbo v3, "delete: size="
    ...
    const-string/jumbo v4, "delete: selection="
    ...
    const-string/jumbo v3, "delete: count="
    ...
    const-string/jumbo v0, "Delete records failed!"
...
.method public getCount(Landroid/database/sqlite/SQLiteDatabase;)I
    ...
    iget-object v0, p0, Lcom/nirvana/tools/logger/cache/db/AbstractDatabase;->mTableName:Ljava/lang/String;

    new-instance v1, Ljava/lang/StringBuilder;

    const-string/jumbo v2, "SELECT COUNT(_id) FROM "
...
.method public declared-synchronized insert(Lcom/nirvana/tools/logger/model/ACMRecord;)Z
    ...
    const-string/jumbo v7, "Table size is limited, clear half of data!"
    ...
    const-string/jumbo v7, "Insert record failed!"
...
.method public declared-synchronized insertList(Ljava/util/List;)Z
    ...
    const-string/jumbo v7, "beginTransaction"
    ...
    const-string/jumbo v8, "writedatabase success  "
    ...
    const-string/jumbo v8, "ContentValues"
...
.method public declared-synchronized query(IILjava/lang/String;)Ljava/util/List;
    ...
    const-string/jumbo v3, "query: selection="
...
.method public declared-synchronized queryFailed(JJI)Ljava/util/List;
    ...
    const-string/jumbo v3, " and _id between ? and ?"
    ...
    const-string/jumbo v14, "_id ASC"
...
.method public declared-synchronized updateUploadCount(Ljava/util/List;JI)V
    ...
    iget-object p3, p0, Lcom/nirvana/tools/logger/cache/db/AbstractDatabase;->mTableName:Ljava/lang/String;

    const-string/jumbo p4, "timestamp"

    const-string/jumbo v1, "upload_flag"

    const-string/jumbo v2, "upload_count"

    const-string/jumbo v3, "upload_count"
    ...
    invoke-virtual {p0, v5, v6}, Lcom/nirvana/tools/logger/cache/db/AbstractDatabase;->contactIds(J)Ljava/lang/String;
    ...
    const-string/jumbo p3, "Update upload count failed!"
