...
.method private a(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 63
    :cond_1
    const-string/jumbo v6, "eventData read from cache file failed because magicNumber error"
    ...
    .line 68
    const-string/jumbo p1, "eventData read from cache file failed cause lengthBuffer error"
    ...
    const-string/jumbo p1, "eventData read from cache file failed cause buffer size not equal length"
    ...
    :cond_8
    :goto_1
    const-string/jumbo p1, "eventData read from cache file failed cause lengthBuffer < 1 || lengthBuffer > 4K"
...
.method private a([Lcom/xiaomi/clientreport/data/a;)[Lcom/xiaomi/clientreport/data/a;
    ...
    :cond_4
    :goto_1
    const-string/jumbo v10, "event data throw a invalid item "
    ...
    :goto_4
    :try_start_5
    const-string/jumbo v0, "event data write to cache file failed cause exception"
...
.method private b(Lcom/xiaomi/clientreport/data/a;)Ljava/lang/String;
    ...
    .line 14
    invoke-static {v1, v0, p1}, Lj80;->c(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public a()V
    ...
    const-string/jumbo v8, "eventData read from cache file failed because "
    ...
    const-string/jumbo v8, " is too big, length "
...
.method public a([Lcom/xiaomi/clientreport/data/a;)V
    ...
    :cond_2
    :goto_0
    const-string/jumbo p1, "event data write to cache file failed because data null"
