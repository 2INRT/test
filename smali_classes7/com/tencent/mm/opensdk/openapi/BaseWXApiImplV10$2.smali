...
.method public onCheckFinish(Z)V
    ...
    const-string/jumbo p1, "WXAPiSecurityHelper, extra check do next step: check pass, doLaunchApp"
    ...
    :cond_0
    const-string/jumbo p1, "WXAPiSecurityHelper, extra check do next step: check fail, stop process!"
