...
.method public checkArgs()Z
    ...
    const-string/jumbo v2, "MicroMsg.PaySdk.PayReq"
    ...
    const-string/jumbo v0, "checkArgs fail, extData length too long"
    ...
    :cond_8
    :goto_1
    const-string/jumbo v0, "checkArgs fail, invalid sign"

    goto :goto_0

    :cond_9
    :goto_2
    const-string/jumbo v0, "checkArgs fail, invalid packageValue"

    goto :goto_0

    :cond_a
    :goto_3
    const-string/jumbo v0, "checkArgs fail, invalid timeStamp"

    goto :goto_0

    :cond_b
    :goto_4
    const-string/jumbo v0, "checkArgs fail, invalid nonceStr"

    goto :goto_0

    :cond_c
    :goto_5
    const-string/jumbo v0, "checkArgs fail, invalid prepayId"

    goto :goto_0

    :cond_d
    :goto_6
    const-string/jumbo v0, "checkArgs fail, invalid partnerId"

    goto :goto_0

    :cond_e
    :goto_7
    const-string/jumbo v0, "checkArgs fail, invalid appId"
