...
# direct methods
.method public static a(Lcom/huawei/hms/location/HWLocation;)Landroid/location/Location;
    .locals 7
    ...
    invoke-static {v0, v1}, Lsx1;->d(Landroid/location/Location;F)V

    invoke-virtual {p0}, Lcom/huawei/hms/location/HWLocation;->getSpeedAccuracyMetersPerSecond()F

    move-result v1

    invoke-static {v0, v1}, Ldq6;->b(Landroid/location/Location;F)V

    invoke-virtual {p0}, Lcom/huawei/hms/location/HWLocation;->getBearingAccuracyDegrees()F

    move-result v1

    invoke-static {v0, v1}, Ltx1;->d(Landroid/location/Location;F)V
    ...
    const-string/jumbo v6, "hw-address-"
    ...
    invoke-virtual {v1, v4, v5}, Landroid/os/Bundle;->putShort(Ljava/lang/String;S)V
    ...
    const-string/jumbo v5, "json exception by key:"
    ...
    const-string/jumbo v4, "LocationJsonUtil"

    const-string/jumbo v5, ""

    invoke-static {v4, v5, v3}, Lcom/huawei/hms/locationSdk/u0;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Lorg/json/JSONObject;)Lcom/huawei/hms/location/HWLocation;
    .locals 11
    ...
    :cond_2
    const-string/jumbo v0, "mProvider"
    ...
    const-string/jumbo v0, "mAltitude"
    ...
    const-string/jumbo v0, "mBearing"
    ...
    const-string/jumbo v6, "mBearingAccuracyDegrees"
    ...
    :cond_3
    const-string/jumbo v6, "mElapsedRealtimeNanos"
    ...
    const-string/jumbo v6, "mHorizontalAccuracyMeters"
    ...
    const-string/jumbo v6, "mLatitude"
    ...
    const-string/jumbo v6, "mSpeedAccuracyMetersPerSecond"
    ...
    const-string/jumbo v0, "mVerticalAccuracyMeters"
    ...
    :cond_5
    invoke-static {p0, v2}, Lcom/huawei/hms/locationSdk/w0;->a(Lorg/json/JSONObject;Lcom/huawei/hms/location/HWLocation;)V
...
.method public static a(Ljava/lang/String;)Lcom/huawei/hms/location/LocationAvailability;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    const-string/jumbo p0, "locationAvailability"
    ...
    const-string/jumbo v1, "cellStatus"
    ...
    const-string/jumbo v1, "elapsedRealtimeNs"
    ...
    const-string/jumbo v1, "locationStatus"
...
.method public static a(Landroid/location/Location;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v3, "mAltitude"
    ...
    const-string/jumbo v3, "mBearing"
    ...
    const-string/jumbo v4, "mElapsedRealtimeNanos"
    ...
    const-string/jumbo v4, "mHorizontalAccuracyMeters"
    ...
    const-string/jumbo v4, "mLatitude"
    ...
    const-string/jumbo v3, "mSpeedAccuracyMetersPerSecond"
    ...
    const-string/jumbo v3, "mVerticalAccuracyMeters"
    ...
    const-string/jumbo v3, "mBearingAccuracyDegrees"
...
.method private static a(Lorg/json/JSONObject;Lcom/huawei/hms/location/HWLocation;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    :cond_0
    const-string/jumbo v0, "mCountryCode"
    ...
    const-string/jumbo v0, "mCountryName"
    ...
    const-string/jumbo v0, "mFeatureName"
    ...
    const-string/jumbo v0, "mPostalCode"
    ...
    const-string/jumbo v0, "mExtraInfo"
    ...
    const-string/jumbo p0, "LocationJsonUtil"

    const-string/jumbo p1, "address extraInfo is null, return"

    invoke-static {p0, v1, p1}, Lcom/huawei/hms/locationSdk/u0;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Lorg/json/JSONObject;)Lcom/huawei/hms/location/LocationResult;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;,
    ...
    :cond_1
    invoke-static {p0}, Lcom/huawei/hms/locationSdk/w0;->c(Lorg/json/JSONObject;)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lcom/huawei/hms/locationSdk/t0;->a(Ljava/util/Collection;)Z
...
.method public static c(Lorg/json/JSONObject;)Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/huawei/hms/locationSdk/w0;->a(Lorg/json/JSONObject;)Lcom/huawei/hms/location/HWLocation;
