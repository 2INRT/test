...
.method public static isHuaweiMobileServicesAvailable(Landroid/content/Context;I)I
    ...
    const-string/jumbo v1, "HuaweiMobileServicesUtil"

    .line 3
    if-eqz v0, :cond_0

    const-string/jumbo p0, "The CP uses the old certificate to terminate the connection."
    ...
    const-string/jumbo v4, "hmsPackageName is "
    ...
    const-string/jumbo p0, "HMS is not installed"
    ...
    const-string/jumbo v9, "B92825C2BD5D6D6D1E7F39EECD17843B7D9016F611136B75441BC6F4D3F00F05"

    const/16 v10, 0x9

    const-string/jumbo v11, "3517262215D8D3008CBF888750B6418EDC4D562AC33ED6874E0D73ABA667BC3C"
    ...
    .line 19
    const-string/jumbo p0, "HMS is spoofed"
    ...
    .line 21
    const-string/jumbo p0, "HMS is disabled"
    ...
    const-string/jumbo v3, "connect versionCode:"
    ...
    const-string/jumbo p0, "The current version does not meet the minimum version requirements"
