...
.method public run()V
    ...
    const-string/jumbo v4, "cached_v2_1"
    ...
    const-string/jumbo v2, "The cacheFile is full,Can not writing data! reqID:"
    ...
    :catch_0
    const-string/jumbo v6, "event to json error"
    ...
    const-string/jumbo v0, "this failed data is too long,can not writing it"
    ...
    const-string/jumbo v5, "data send failed, write to cache file...reqID:"
    ...
    :cond_5
    :goto_1
    const-string/jumbo v0, "failed events is empty"
