...
.method public static c()Ljava/lang/String;
    ...
    :try_start_2
    const-string/jumbo v1, "getUDID success"
    ...
    :catch_6
    :goto_0
    const-string/jumbo v2, "getUDID method invoke failed : InvocationTargetException"
    ...
    :catch_7
    :goto_2
    const-string/jumbo v2, "getUDID method invoke failed : Illegal ArgumentException"

    goto :goto_1

    :catch_8
    :goto_3
    const-string/jumbo v2, "getUDID method invoke failed : Illegal AccessException"

    goto :goto_1

    :catch_9
    :goto_4
    const-string/jumbo v2, "getUDID method invoke failed : NoSuchMethodException"

    goto :goto_1

    :catch_a
    :goto_5
    const-string/jumbo v2, "getUDID getudid failed, RuntimeException is AndroidRuntimeException"

    goto :goto_1

    :catch_b
    :goto_6
    const-string/jumbo v2, "getUDID method invoke failed"
...
.method public static e(Landroid/content/Context;)Landroid/util/Pair;
    ...
    const-string/jumbo v0, "getMccAndMnc() Pair value is empty"
