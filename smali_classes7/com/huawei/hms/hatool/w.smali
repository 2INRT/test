...
.method public static a(Ljava/lang/String;[BLjava/util/Map;Ljava/lang/String;)Lcom/huawei/hms/hatool/n0;
    ...
    new-instance v3, Lcom/huawei/hms/hatool/n0;

    invoke-direct {v3, v4, p1}, Lcom/huawei/hms/hatool/n0;-><init>(ILjava/lang/String;)V
    :try_end_4
    ...
    :goto_8
    :try_start_5
    const-string/jumbo p0, "events PostRequest(byte[]): IOException occurred."
    ...
    :goto_a
    :try_start_6
    const-string/jumbo p0, "No address associated with hostname or No network"
    ...
    :goto_c
    :try_start_7
    const-string/jumbo p0, "Network is unreachable or Connection refused"
    ...
    :goto_e
    :try_start_8
    const-string/jumbo p0, "Chain validation failed,Certificate expired"
    ...
    :goto_10
    :try_start_9
    const-string/jumbo p0, "Certificate has not been verified,Request is restricted!"
    ...
    :goto_12
    :try_start_a
    const-string/jumbo p0, "SecurityException with HttpClient. Please check INTERNET permission."
    ...
    :goto_14
    :try_start_b
    const-string/jumbo p0, "PostRequest(byte[]): No ssl socket factory set!"
...
.method private static a(Ljava/lang/String;ILjava/util/Map;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    const-string/jumbo p0, "hmsSdk"

    const-string/jumbo p1, "CreateConnection: invalid urlPath."
...
.method private static a(Ljava/net/HttpURLConnection;)V
    ...
    invoke-static {v1}, Lc85;->b(Landroid/content/Context;)Lc85;
    ...
    :catch_0
    const-string/jumbo v1, "getSocketFactory(): Illegal Access Exception "
    ...
    :catch_1
    const-string/jumbo v1, "getSocketFactory(): IO Exception!"

    goto :goto_0

    :catch_2
    const-string/jumbo v1, "getSocketFactory(): General Security Exception"

    goto :goto_0

    :catch_3
    const-string/jumbo v1, "getSocketFactory(): Key Store exception"

    goto :goto_0

    :catch_4
    const-string/jumbo v1, "getSocketFactory(): Algorithm Exception!"
    ...
    const-string/jumbo v0, "No ssl socket factory set"
...
.method private static b(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "When Response Content From Connection inputStream operation exception! "
