...
.method private a(Landroid/content/Context;Lcom/huawei/hms/api/Api;Lcom/huawei/hms/api/Api$ApiOptions;Lcom/huawei/hms/common/internal/AbstractClientBuilder;ILjava/lang/String;)V
    ...
    const-string/jumbo p3, "HuaweiApi"

    .line 12
    if-eqz p2, :cond_0

    const-string/jumbo p2, "subAppId is host appid"
    ...
    :cond_0
    const-string/jumbo p2, "subAppId is "
...
.method private a(Lcom/huawei/hms/common/HuaweiApi;Lcom/huawei/hmf/tasks/TaskCompletionSource;)V
    ...
    .line 18
    const-string/jumbo v0, "innerDisconnect."
    ...
    const-string/jumbo v0, "disconnect the binder failed for:"
...
.method public doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lcom/huawei/hmf/tasks/Task;
    ...
    .line 8
    .line 9
    const-string/jumbo v0, "in doWrite:taskApiCall is null"
...
.method public getClientSetting()Lcom/huawei/hms/common/internal/ClientSettings;
    ...
    .line 49
    .line 50
    const-string/jumbo v1, "No setInnerHms, hms pkg name is "
...
.method public setInnerHms()V
    ...
    .line 13
    .line 14
    const-string/jumbo v1, "<setInnerHms> init inner hms pkg info:"
...
.method public setSubAppInfo(Lcom/huawei/hms/support/api/client/SubAppInfo;)Z
    ...
    .line 24
    .line 25
    const-string/jumbo p1, "subAppInfo is already set"
    ...
    .line 76
    .line 77
    const-string/jumbo p1, "Client has sent request to Huawei Mobile Services, setting subAppId is not allowed"
