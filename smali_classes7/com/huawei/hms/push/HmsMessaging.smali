...
.method static constructor <clinit>()V
    ...
    .line 1
    const-string/jumbo v0, "[\\u4e00-\\u9fa5\\w-_.~%]{1,900}"
...
.method public final a(Ljava/lang/String;Ljava/lang/String;)Lcom/huawei/hmf/tasks/Task;
    ...
    const-string/jumbo v1, "push.subscribe"
    ...
    const-string/jumbo v2, "HmsMessaging"
    ...
    const-string/jumbo p1, "Invalid topic: topic should match the format:[\\u4e00-\\u9fa5\\w-_.~%]{1,900}"
...
.method public final a(Z)Lcom/huawei/hmf/tasks/Task;
    ...
    const-string/jumbo v3, "HmsMessaging"
    ...
    .line 65
    const-string/jumbo p1, "operation not available on Huawei device with EMUI lower than 5.1"
    ...
    const-string/jumbo v7, "enalbeFlag"
    ...
    const-string/jumbo v2, "com.huawei.intent.action.SELF_SHOW_FLAG"
    ...
    .line 78
    const-string/jumbo v3, "push_notify_flag"
    ...
    const-string/jumbo v1, ".huawei.push.provider/push_notify_flag.xml"
    ...
    .line 82
    const-string/jumbo v2, "com.huawei.android.push.intent.SDK_COMMAND"
...
.method public final a(Lcom/huawei/hms/push/RemoteMessage;)V
    ...
    const-string/jumbo v1, "push.sendMessage"
    ...
    const-string/jumbo v4, "HmsMessaging"
    ...
    :cond_1
    const-string/jumbo p1, "Mandatory parameter \'data\' missing"
    ...
    :cond_2
    const-string/jumbo p1, "Mandatory parameter \'message_id\' missing"
    ...
    :cond_3
    const-string/jumbo p1, "Mandatory parameter \'to\' missing"
    ...
    const-string/jumbo v3, "Message sent failed:"
...
.method public final a(Lcom/huawei/hms/support/api/entity/push/UpSendMsgReq;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "push.sendMessage"
...
.method public send(Lcom/huawei/hms/push/RemoteMessage;)V
    ...
    .line 5
    const-string/jumbo v1, "HmsMessaging"
    ...
    .line 9
    .line 10
    const-string/jumbo v0, "send upstream message"
    ...
    .line 20
    :cond_0
    const-string/jumbo p1, "Operation(send) unsupported"
...
.method public subscribe(Ljava/lang/String;)Lcom/huawei/hmf/tasks/Task;
    ...
    .line 1
    const-string/jumbo v0, "HmsMessaging"

    .line 2
    .line 3
    .line 4
    const-string/jumbo v1, "invoke subscribe"
...
.method public turnOffPush()Lcom/huawei/hmf/tasks/Task;
    ...
    .line 28
    :cond_0
    const-string/jumbo v0, "invoke turnOffPush"
...
.method public turnOnPush()Lcom/huawei/hmf/tasks/Task;
    ...
    .line 28
    :cond_0
    const-string/jumbo v0, "invoke turnOnPush"
...
.method public unsubscribe(Ljava/lang/String;)Lcom/huawei/hmf/tasks/Task;
    ...
    .line 3
    .line 4
    const-string/jumbo v1, "invoke unsubscribe"
