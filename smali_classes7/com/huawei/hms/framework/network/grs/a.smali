...
.method public static a(Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string/jumbo v1, "isSpExpire jsonValue is null."
    ...
    const-string/jumbo p0, "getServicesUrlsMap occur a JSONException: %s"
...
.method private a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/b;Landroid/content/Context;)Ljava/util/Map;
    ...
    const-string/jumbo p3, "GrsClientManager.getUrlsLocal: Get URL from GRS Server Cache"
    ...
    const-string/jumbo p3, "GrsClientManager.getUrlsLocal: Get URL from Local JSON File"
...
.method public static a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string/jumbo p1, "isSpExpire jsonValue from server is null."
    ...
    const-string/jumbo v3, "getServiceNameUrls: paser null from server json data by {%s}."
    ...
    const-string/jumbo p0, "Method{getServiceNameUrls} query url from SP occur an JSONException: %s"

    invoke-static {p1, p0, v1}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static a(Lorg/json/JSONObject;)Ljava/util/Map;
    ...
    const-string/jumbo p0, "getServiceUrls occur a JSONException: %s"
...
.method public a(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v14, "GrsClientManager.synGetGrsUrl: Return [%s][%s] Url: %s"
    ...
    invoke-static {v1, v14, v4}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v2, "GrsClientManager.synGetGrsUrl: Get URL from Current Called GRS Server, Return [%s][%s] Url: %s"
    ...
    const-string/jumbo v4, "The serviceName[%s][%s] is not configured on the GRS server."
    ...
    const-string/jumbo v1, "GrsClientManager.synGetGrsUrl: Get URL from Local JSON File."
    ...
    const-string/jumbo v2, "The serviceName[%s][%s] is not configured in the JSON configuration files to reveal all the details"
...
.method public a(Ljava/lang/String;Landroid/content/Context;)Ljava/util/Map;
    ...
    new-instance v3, Lcom/huawei/hms/framework/network/grs/e/b;

    invoke-direct {v3}, Lcom/huawei/hms/framework/network/grs/e/b;-><init>()V

    invoke-direct {p0, p1, v3, p2}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/b;Landroid/content/Context;)Ljava/util/Map;

    move-result-object v4

    invoke-virtual {v3}, Lcom/huawei/hms/framework/network/grs/e/b;->a()Z
    ...
    const-string/jumbo p1, "Return [%s] Urls: %s"
    ...
    invoke-static {v3, p1}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string/jumbo p1, "GrsClientManager.synGetGrsUrls: Get URL from Current Called GRS Server Return [%s] Urls: %s"
    ...
    sget-object v3, Lcom/huawei/hms/framework/network/grs/a;->e:Ljava/lang/String;

    new-array v4, v1, [Ljava/lang/Object;

    aput-object p1, v4, v2

    const-string/jumbo v5, "The serviceName[%s] is not configured on the GRS server."

    invoke-static {v3, v5, v4}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :cond_2
    sget-object v3, Lcom/huawei/hms/framework/network/grs/a;->e:Ljava/lang/String;

    const-string/jumbo v4, "GrsClientManager.synGetGrsUrls: Get URL from Local JSON File."
    ...
    invoke-static {v4, v5}, Lcom/huawei/hms/framework/network/grs/f/b;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;)Lcom/huawei/hms/framework/network/grs/f/b;
    ...
    const-string/jumbo v5, "The serviceName[%s] is not configured in the JSON configuration files to reveal all the details"

    invoke-static {v3, v5, p2}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo p1, "GrsClientManager.synGetGrsUrls: Return [%s] Urls: %s"
...
.method public a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/IQueryUrlsCallBack;Landroid/content/Context;)V
    ...
    new-instance v2, Lcom/huawei/hms/framework/network/grs/e/b;

    invoke-direct {v2}, Lcom/huawei/hms/framework/network/grs/e/b;-><init>()V

    invoke-direct {p0, p1, v2, p3}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/b;Landroid/content/Context;)Ljava/util/Map;

    move-result-object v5

    invoke-virtual {v2}, Lcom/huawei/hms/framework/network/grs/e/b;->a()Z
    ...
    const-string/jumbo p1, "GrsClientManager.ayncGetGrsUrls\uff1aReturn [%s] Urls is Empty"
    ...
    const-string/jumbo p1, "GrsClientManager.ayncGetGrsUrls\uff1aReturn [%s] Urls: %s"

    invoke-static {p3, p1, v3}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo p1, "ayncGetGrsUrls: %s"

    invoke-static {p3, p1, v1}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {p2, v5}, Lcom/huawei/hms/framework/network/grs/IQueryUrlsCallBack;->onCallBackSuccess(Ljava/util/Map;)V
    ...
    invoke-direct/range {v3 .. v9}, Lcom/huawei/hms/framework/network/grs/a$a;-><init>(Ljava/lang/String;Ljava/util/Map;Lcom/huawei/hms/framework/network/grs/IQueryUrlsCallBack;Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Lcom/huawei/hms/framework/network/grs/e/a;)V

    iget-object p2, p0, Lcom/huawei/hms/framework/network/grs/a;->d:Lcom/huawei/hms/framework/network/grs/e/c;

    invoke-virtual {v1, v0, v2, p1, p2}, Lcom/huawei/hms/framework/network/grs/g/h;->a(Lcom/huawei/hms/framework/network/grs/g/k/c;Lcom/huawei/hms/framework/network/grs/b;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)V
...
.method public a(Ljava/lang/String;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/IQueryUrlCallBack;Landroid/content/Context;)V
    ...
    new-instance v7, Lcom/huawei/hms/framework/network/grs/e/b;

    invoke-direct {v7}, Lcom/huawei/hms/framework/network/grs/e/b;-><init>()V

    invoke-direct {p0, p1, v7, v6}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/b;Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-virtual {v7}, Lcom/huawei/hms/framework/network/grs/e/b;->a()Z
    ...
    sget-object v6, Lcom/huawei/hms/framework/network/grs/a;->e:Ljava/lang/String;
    ...
    const-string/jumbo v1, "GrsClientManager.ayncGetGrsUrl\uff1aReturn [%s][%s] Url is Empty"

    invoke-static {v6, v1, v5}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "GrsClientManager.ayncGetGrsUrl\uff1aReturn [%s][%s] Url: %s"

    invoke-static {v6, v1, v10}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {v4, v8}, Lcom/huawei/hms/framework/network/grs/IQueryUrlCallBack;->onCallBackSuccess(Ljava/lang/String;)V

    :goto_0
    return-void

    :cond_1
    new-instance v10, Lcom/huawei/hms/framework/network/grs/g/k/c;

    iget-object v1, v0, Lcom/huawei/hms/framework/network/grs/a;->a:Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;

    invoke-direct {v10, v1, v6}, Lcom/huawei/hms/framework/network/grs/g/k/c;-><init>(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Landroid/content/Context;)V

    iget-object v11, v0, Lcom/huawei/hms/framework/network/grs/a;->c:Lcom/huawei/hms/framework/network/grs/g/h;
    ...
    iget-object v13, v0, Lcom/huawei/hms/framework/network/grs/a;->b:Lcom/huawei/hms/framework/network/grs/e/a;
    ...
    iget-object v1, v0, Lcom/huawei/hms/framework/network/grs/a;->d:Lcom/huawei/hms/framework/network/grs/e/c;

    invoke-virtual {v11, v10, v12, p1, v1}, Lcom/huawei/hms/framework/network/grs/g/h;->a(Lcom/huawei/hms/framework/network/grs/g/k/c;Lcom/huawei/hms/framework/network/grs/b;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)V
