...
.method private a(Ljava/util/Map;)V
    ...
    const-string/jumbo v0, "The Response Heads Etag is Empty"
    ...
    const-string/jumbo v0, "Response Heads has not Etag"
...
.method private b(Ljava/util/Map;)V
    ...
    const-string/jumbo v8, "Cache-Control value{%s}"
    ...
    const-string/jumbo v9, "getExpireTime addHeadersToResult NumberFormatException"
    ...
    const-string/jumbo v9, "expires is{%s}"

    invoke-static {v3, v9, v8}, Lcom/huawei/hms/framework/common/Logger;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v3, Ljava/text/SimpleDateFormat;

    sget-object v8, Ljava/util/Locale;->ROOT:Ljava/util/Locale;

    const-string/jumbo v9, "EEE, d MMM yyyy HH:mm:ss \'GMT\'"
    ...
    :goto_3
    sget-object v2, Lcom/huawei/hms/framework/network/grs/g/d;->o:Ljava/lang/String;

    const-string/jumbo v3, "getExpireTime ParseException."
    ...
    const-string/jumbo v2, "response headers neither contains Cache-Control nor Expires."

    invoke-static {p1, v2}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    const-string/jumbo v0, "convert expireTime{%s}"
...
.method private c(Ljava/util/Map;)V
    ...
    const-string/jumbo v1, "getRetryAfter addHeadersToResult NumberFormatException"
    ...
    const-string/jumbo v2, "convert retry-afterTime{%s}"
...
.method private p()V
    ...
    const-string/jumbo v1, "errorList"
    ...
    const-string/jumbo v1, "GRSSDK get httpcode{304} not any changed."
    ...
    const-string/jumbo v1, "GRSSDK parse server body all failed."

    invoke-static {v0, v1}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V

    invoke-direct {p0, v8}, Lcom/huawei/hms/framework/network/grs/g/d;->c(I)V

    return-void

    :cond_1
    :try_start_0
    iget-object v6, p0, Lcom/huawei/hms/framework/network/grs/g/d;->b:[B

    invoke-static {v6}, Lcom/huawei/hms/framework/common/StringUtils;->byte2Str([B)Ljava/lang/String;
    ...
    :cond_4
    sget-object v4, Lcom/huawei/hms/framework/network/grs/g/d;->o:Ljava/lang/String;

    const-string/jumbo v5, "sth. wrong because server errorcode\'s key."

    invoke-static {v4, v5}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    ...
    :cond_5
    invoke-direct {p0, v4}, Lcom/huawei/hms/framework/network/grs/g/d;->c(I)V
    :try_end_1
    ...
    :cond_8
    invoke-direct {p0, v6}, Lcom/huawei/hms/framework/network/grs/g/d;->d(Ljava/lang/String;)V
    ...
    :goto_4
    invoke-direct {p0, v2}, Lcom/huawei/hms/framework/network/grs/g/d;->f(Ljava/lang/String;)V
    ...
    :cond_b
    invoke-direct {p0, v6}, Lcom/huawei/hms/framework/network/grs/g/d;->e(Ljava/lang/String;)V
    :try_end_2
    ...
    const-string/jumbo v0, "GrsResponse GrsResponse(String result) JSONException: %s"

    invoke-static {v2, v0, v3}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private q()V
    ...
    const-string/jumbo v1, "parseHeader {headers.size() <= 0}"
    ...
    const-string/jumbo v0, "parseHeader catch JSONException: %s"
...
.method private r()Ljava/util/Map;
    ...
    const-string/jumbo v2, "parseRespHeaders {respHeaders == null} or {respHeaders.size() <= 0}"
