...
.method public call()Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    const-string/jumbo v2, "RequestCallableV2 disconnect HttpsURLConnection catch RuntimeException"

    const-string/jumbo v3, "RequestCallableV2 disconnect HttpsURLConnection catch Throwable"

    sget-object v0, Lcom/huawei/hms/framework/network/grs/g/g;->i:Ljava/lang/String;

    const-string/jumbo v4, "Post call execute"
    ...
    :try_start_2
    const-string/jumbo v10, "create HttpsURLConnection instance by url return null."
    ...
    const-string/jumbo v10, "application/json; charset=UTF-8"
    ...
    :goto_2
    const-string/jumbo v11, "If-None-Match"
    ...
    const-string/jumbo v12, "RequestCallableV2 run task catch IOException"
