...
.method private a(Ljava/util/concurrent/ExecutorService;Ljava/util/List;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    :try_start_0
    iget-wide v4, v9, Lcom/huawei/hms/framework/network/grs/g/c;->m:J
    ...
    const-string/jumbo v4, "grs request return body is not null and is OK."
    ...
    const-string/jumbo v1, "the wait timed out"
    ...
    const-string/jumbo v4, "the current thread was interrupted while waiting"
    ...
    const-string/jumbo v3, "the computation threw an ExecutionException"
    ...
    const-string/jumbo v1, "{requestServer} the computation was cancelled"
    ...
    const-string/jumbo v1, "needBreak is true so need break current circulation"
...
.method private a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/huawei/hms/framework/network/grs/g/c;->i:Ljava/util/List;
...
.method private b(Lcom/huawei/hms/framework/network/grs/g/d;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    const-string/jumbo v3, "{checkResponse} when check result, find TimeoutException, cancel current request task"
    ...
    const-string/jumbo v3, "{checkResponse} when check result, find InterruptedException, check others"
    ...
    const-string/jumbo v3, "{checkResponse} when check result, find ExecutionException, check others"
    ...
    const-string/jumbo v2, "{checkResponse} when check result, find CancellationException, check others"
...
.method private b(Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    iget-object v3, p0, Lcom/huawei/hms/framework/network/grs/g/c;->i:Ljava/util/List;

    invoke-direct {p0, p1, v3, p2, p3}, Lcom/huawei/hms/framework/network/grs/g/c;->a(Ljava/util/concurrent/ExecutorService;Ljava/util/List;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    :cond_0
    invoke-virtual {v3}, Lcom/huawei/hms/framework/network/grs/g/d;->b()I
    ...
    const-string/jumbo v0, "use 2.0 interface return http\'s code is\uff1a{%s}"

    invoke-static {v5, v0, v7}, Lcom/huawei/hms/framework/common/Logger;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo p1, "request grs server use 1.0 API must set appName,please check."
    ...
    const-string/jumbo v0, "this env has not deploy new interface,so use old interface."

    invoke-static {v5, v0}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v0, p0, Lcom/huawei/hms/framework/network/grs/g/c;->h:Ljava/util/List;

    invoke-direct {p0, p1, v0, p2, p3}, Lcom/huawei/hms/framework/network/grs/g/c;->a(Ljava/util/concurrent/ExecutorService;Ljava/util/List;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
...
.method private b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0, v0, v2, v1}, Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;->getGrsReqParamJoint(ZZLjava/lang/String;Landroid/content/Context;)Ljava/lang/String;
...
.method private c()V
    ...
    const-string/jumbo v1, "g*s***_se****er_conf*** maybe has a big error"
    ...
    const-string/jumbo v4, "grs server just support https scheme url,please check."
    ...
    const-string/jumbo v1, "request to GRS server url is{%s} and {%s}"
    ...
    const-string/jumbo v1, "grs_base_url\'s count is larger than MAX value 10"
    ...
    const-string/jumbo v1, "maybe grs_base_url config with [],please check."
...
.method private e()Ljava/lang/String;
    ...
    const-string/jumbo v3, "get appName from local assets is{%s}"
...
.method public a(Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    const-string/jumbo p3, "{submitExcutorTaskWithTimeout} catch Exception"
    ...
    const-string/jumbo p2, "{submitExcutorTaskWithTimeout} the wait timed out"
    ...
    const-string/jumbo p3, "{submitExcutorTaskWithTimeout} the current thread was interrupted while waiting"
    ...
    const-string/jumbo p3, "{submitExcutorTaskWithTimeout} the computation threw an ExecutionException"
    ...
    const-string/jumbo p2, "{submitExcutorTaskWithTimeout} the computation was cancelled"
...
.method public declared-synchronized a(Lcom/huawei/hms/framework/network/grs/g/d;)V
    ...
    const-string/jumbo v0, "grsResponseResult is ok"
    ...
    const-string/jumbo v2, "GRS server open 503 limiting strategy."
    ...
    const-string/jumbo v2, "GRS server open 304 Not Modified."
    ...
    const-string/jumbo v0, "grsResponseResult has exception so need return"
    ...
    const-string/jumbo v4, "future cancel"
