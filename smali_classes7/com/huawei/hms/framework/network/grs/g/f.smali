...
.method public call()Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    const-string/jumbo v2, "RequestCallableV1 disconnect HttpsURLConnection catch RuntimeException"

    const-string/jumbo v3, "RequestCallableV1 disconnect HttpsURLConnection catch Throwable"

    sget-object v0, Lcom/huawei/hms/framework/network/grs/g/f;->i:Ljava/lang/String;

    const-string/jumbo v4, "Get call execute"
    ...
    :goto_2
    const-string/jumbo v10, "If-None-Match"
    ...
    const-string/jumbo v12, "RequestCallable run task catch IOException"
