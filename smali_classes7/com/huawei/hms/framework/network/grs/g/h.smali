...
.method public constructor <init>()V
    ...
    const-string/jumbo v0, "GRS_RequestController-Task"
...
.method private a(Lcom/huawei/hms/framework/network/grs/g/d;Lcom/huawei/hms/framework/network/grs/b;)V
    ...
    const-string/jumbo v0, "RequestController"

    if-nez p1, :cond_0

    const-string/jumbo p1, "GrsResponse is null"
    ...
    :cond_0
    const-string/jumbo v1, "GrsResponse is not null"
...
.method public a(Lcom/huawei/hms/framework/network/grs/g/k/c;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    const-string/jumbo v1, "request to server with service name is: "
    ...
    const-string/jumbo v1, "RequestController"
    ...
    const-string/jumbo v2, "request spUrlKey: "
    ...
    const-string/jumbo v2, "RequestController"
    ...
    const-string/jumbo v4, "hitGrsRequestBean == null or request block is released."
    ...
    :goto_3
    const-string/jumbo p2, "RequestController"

    const-string/jumbo p3, "when check result, find InterruptedException, check others"
    ...
    const-string/jumbo p3, "when check result, find ExecutionException, check others"
    ...
    const-string/jumbo p3, "when check result, find CancellationException, check others"
