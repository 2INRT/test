...
.method public static a(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)Ljavax/net/ssl/HttpsURLConnection;
    ...
    const-string/jumbo v2, "URLConnectionHelper"
    ...
    :catch_0
    const-string/jumbo v0, "init https ssl socket failed."
    ...
    const-string/jumbo v0, "NetworkKit-grs"
    ...
    const-string/jumbo v0, "request to grs server with a User-Agent header is: "
    ...
    :cond_1
    const-string/jumbo p0, "urlConnection is not an instance of HttpsURLConnection"
...
.method public static a(Ljavax/net/ssl/HttpsURLConnection;Ljava/lang/String;)V
    ...
    .line 2
    const-string/jumbo v0, "URLConnectionHelper"

    if-nez p1, :cond_0

    const-string/jumbo p0, "sendHttpBody: The Body Data is Null"
    ...
    const-string/jumbo p0, "sendHttpBody: HttpsURLConnection is Null"
