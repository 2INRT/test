...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    const-string/jumbo p2, "grs_sdk_global_route_config.json"
...
.method private a(Lorg/json/JSONObject;)Ljava/util/List;
    ...
    const-string/jumbo v2, "LocalManagerV1"
    ...
    const-string/jumbo p1, "parse countryGroups failed maybe json style is wrong. %s"
...
.method public a(Ljava/lang/String;)I
    ...
    const-string/jumbo v3, "cacheControl"
    ...
    const-string/jumbo p1, "LocalManagerV1"
...
.method public b(Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "LocalManagerV1"
...
.method public e(Ljava/lang/String;)I
    ...
    const-string/jumbo v0, "countryGroups"

    const-string/jumbo v4, "countryOrAreaGroups"

    const-string/jumbo v5, "countryGroup"

    const-string/jumbo v6, "countryOrAreaGroup"

    const-string/jumbo v7, "LocalManagerV1"
    ...
    const-string/jumbo v13, "routeBy"
    ...
    const-string/jumbo v13, "servings"
    ...
    :cond_2
    const-string/jumbo v2, "maybe this service routeBy is unconditional."
    ...
    invoke-direct {v15, v5}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V
    ...
    invoke-virtual {v15, v5, v6}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_7
    const-string/jumbo v2, "service use default countryOrAreaGroup"
    ...
    const-string/jumbo v0, "parse 1.0 services failed maybe because of json style.please check! %s"
