...
.method private a(Ljava/util/List;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string/jumbo v1, "no_route_country"

    const-string/jumbo v2, "no-country"
    ...
    const-string/jumbo v2, "AbstractLocalManager"

    const-string/jumbo v3, "get countryGroupID from geoIp"
...
.method private b(Ljava/lang/String;Landroid/content/Context;)I
    ...
    const-string/jumbo p1, "AbstractLocalManager"

    const-string/jumbo v1, "load APP_CONFIG_FILE success{%s}."
...
.method public a(Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/e/a;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string/jumbo p2, "AbstractLocalManager"

    const-string/jumbo p3, "addresses not found by routeby in local config{%s}"
...
.method public a(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    const-string/jumbo v4, "countriesOrAreas"
    ...
    :cond_2
    const-string/jumbo v8, "current country or area group has not config countries or areas."
    ...
    const-string/jumbo p1, "parse countrygroup failed maybe json style is wrong. %s"
...
.method public a(Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/e/a;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Ljava/lang/String;Z)Ljava/util/Map;
    ...
    const-string/jumbo v3, "AbstractLocalManager"

    const/4 v4, 0x0

    if-nez v2, :cond_0

    const-string/jumbo p1, "application data is null."
    ...
    const-string/jumbo p2, "service not found in local config{%s}"
    ...
    const-string/jumbo p1, "country not found by routeby in local config{%s}"
...
.method public a(Landroid/content/Context;Ljava/util/List;)V
    ...
    const-string/jumbo v3, "^grs_sdk_global_route_config_[a-zA-Z]+\\.json$"
    ...
    const-string/jumbo v4, "AbstractLocalManager"
    ...
    const-string/jumbo v2, "load SDK_CONFIG_FILE: %s, sucess."
    ...
    const-string/jumbo v2, "load SDK_CONFIG_FILE: %s, failure."
...
.method public b(Lorg/json/JSONArray;)V
    ...
    const-string/jumbo v8, "servings"
    ...
    const-string/jumbo v11, "AbstractLocalManager"
    ...
    const-string/jumbo v13, "countryOrAreaGroup"
    ...
    :cond_1
    const-string/jumbo v13, "countryGroup"
    ...
    const-string/jumbo v14, "maybe this service{%s} routeBy is unconditional."
    ...
    :cond_5
    const-string/jumbo v8, "countryOrAreaGroups"
    ...
    :cond_6
    const-string/jumbo v8, "countryGroups"
    ...
    :cond_7
    const-string/jumbo v5, "service use default countryOrAreaGroup"
...
.method public c(Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "AbstractLocalManager"

    const-string/jumbo v2, "countryGroups"

    const-string/jumbo v3, "countryOrAreaGroups"
...
.method public d(Ljava/lang/String;)I
    ...
    const-string/jumbo v0, "parse 2.0 services failed maybe because of json style.please check! %s"
