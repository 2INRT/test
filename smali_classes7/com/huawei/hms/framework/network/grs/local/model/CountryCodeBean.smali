...
.method private getLocaleCountryCode()V
    ...
    const-string/jumbo v1, "EMUI 9.0 upper System, get countryCode form Locale.getDefault().getCountry()"
    ...
    const-string/jumbo v1, "EMUI 9.0 lower System, get countryCode form ro.product.locale.region or locale"
    ...
    const-string/jumbo v1, "other Android 9.0 lower, get countryCode form ro.product.locale.region or locale"
    ...
    const-string/jumbo v1, "other Android 9.0 upper\uff0c get countryCode form Locale.getDefault().getCountry()"

    goto :goto_0

    :goto_2
    const-string/jumbo v0, "LOCALE_INFO"
...
.method private getProductCountryCode()V
    ...
    const-string/jumbo v5, "countryCode by ro.product.locale.region is: "
    ...
    :cond_0
    const-string/jumbo v4, "ro.product.locale"
    ...
    const-string/jumbo v2, "countryCode by ro.product.locale is: "
...
.method private getRegionSettingCountryCode()V
    ...
    const-string/jumbo v2, "countryCode by system\'s region setting is: "
...
.method private getSimCountryCode(Landroid/content/Context;Z)V
    ...
    const-string/jumbo p1, "NETWORK_COUNTRY"
    ...
    const-string/jumbo v0, "countryCode by NetworkCountryIso is: "
    ...
    const-string/jumbo p1, "SIM_COUNTRY"
    ...
    const-string/jumbo v0, "countryCode by SimCountryIso is: "
...
.method private getVendorCountryCode()V
    ...
    const-string/jumbo v0, "VENDOR_COUNTRY"

    iput-object v0, p0, Lcom/huawei/hms/framework/network/grs/local/model/CountryCodeBean;->countrySource:Ljava/lang/String;

    const-string/jumbo v1, "get"

    const-string/jumbo v2, "ro.hw.country"
    ...
    const-string/jumbo v3, "countryCode by ro.hw.country is: "
    ...
    const-string/jumbo v2, "special country of UK to map GB."
...
.method private init(Landroid/content/Context;Z)V
    ...
    const-string/jumbo p2, "get issue_country code from VENDOR_COUNTRY"
    ...
    const-string/jumbo p2, "get issue_country code from SIM_COUNTRY"
    ...
    const-string/jumbo p2, "get issue_country code from LOCALE_INFO"
    ...
    const-string/jumbo p2, "get CountryCode error"
    ...
    const-string/jumbo p2, "context must be not null.Please provide app\'s Context"
