...
.method public a()V
    ...
    const-string/jumbo v5, "GrsClientManager.ayncGetGrsUrl: Return [%s][%s] Url: %s"
    ...
    invoke-static {v4, v5, v0}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v6, "GrsClientManager.ayncGetGrsUrl: Get URL from Local JSON File"

    invoke-static {v4, v6}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v4, v6}, Lcom/huawei/hms/framework/network/grs/f/b;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;)Lcom/huawei/hms/framework/network/grs/f/b;
    ...
    const-string/jumbo v7, "The serviceName[%s][%s] is not configured in the JSON configuration files to reveal all the details"
    ...
    invoke-static {v6, v5, v0}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, p0, Lcom/huawei/hms/framework/network/grs/a$b;->c:Lcom/huawei/hms/framework/network/grs/IQueryUrlCallBack;

    invoke-interface {v0, v4}, Lcom/huawei/hms/framework/network/grs/IQueryUrlCallBack;->onCallBackSuccess(Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/huawei/hms/framework/network/grs/a$b;->a:Ljava/lang/String;
    ...
    const-string/jumbo v2, "GrsClientManager.ayncGetGrsUrl\uff1aReturn [%s][%s] Url is Empty"
...
.method public a(Lcom/huawei/hms/framework/network/grs/g/d;)V
    ...
    invoke-static {p1, v4}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string/jumbo v1, "GrsClientManager.ayncGetGrsUrl: Get URL from Current Called GRS Server, Return [%s][%s] Url: %s"
    ...
    iget-object v0, p0, Lcom/huawei/hms/framework/network/grs/a$b;->b:Ljava/lang/String;
    ...
    :cond_0
    iget-object v5, p0, Lcom/huawei/hms/framework/network/grs/a$b;->d:Ljava/lang/String;

    invoke-static {v5}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v5

    const-string/jumbo v6, "GrsClientManager.ayncGetGrsUrl: Return [%s][%s] Url: %s"
    ...
    invoke-static {p1, v6, v0}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, v4, v7}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v4, "GrsClientManager.ayncGetGrsUrl: Get URL from Local JSON File"

    invoke-static {p1, v4}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p1, v4}, Lcom/huawei/hms/framework/network/grs/f/b;->a(Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;)Lcom/huawei/hms/framework/network/grs/f/b;
    ...
    const-string/jumbo v5, "The serviceName[%s][%s] is not configured in the JSON configuration files to reveal all the details"

    invoke-static {v4, v5, v8}, Lcom/huawei/hms/framework/common/Logger;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v4, v6, v0}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v0, "GrsClientManager.ayncGetGrsUrl\uff1aReturn [%s][%s] Url is Empty"
