...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "AR_HAND_UNKNOWN"

    const/4 v3, 0x0

    invoke-direct {v0, v2, v3, v1}, Lcom/huawei/hiar/ARHand$ARHandType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/huawei/hiar/ARHand$ARHandType;->AR_HAND_UNKNOWN:Lcom/huawei/hiar/ARHand$ARHandType;

    new-instance v1, Lcom/huawei/hiar/ARHand$ARHandType;

    const-string/jumbo v2, "AR_HAND_RIGHT"

    const/4 v4, 0x1

    invoke-direct {v1, v2, v4, v3}, Lcom/huawei/hiar/ARHand$ARHandType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/huawei/hiar/ARHand$ARHandType;->AR_HAND_RIGHT:Lcom/huawei/hiar/ARHand$ARHandType;

    new-instance v2, Lcom/huawei/hiar/ARHand$ARHandType;

    const-string/jumbo v5, "AR_HAND_LEFT"

    const/4 v6, 0x2

    invoke-direct {v2, v5, v6, v4}, Lcom/huawei/hiar/ARHand$ARHandType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/huawei/hiar/ARHand$ARHandType;->AR_HAND_LEFT:Lcom/huawei/hiar/ARHand$ARHandType;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/huawei/hiar/ARHand$ARHandType;
    ...
    sput-object v5, Lcom/huawei/hiar/ARHand$ARHandType;->$VALUES:[Lcom/huawei/hiar/ARHand$ARHandType;
...
.method public static forNumber(I)Lcom/huawei/hiar/ARHand$ARHandType;
    .locals 5
    ...
    :cond_1
    sget-object p0, Lcom/huawei/hiar/ARHand$ARHandType;->AR_HAND_UNKNOWN:Lcom/huawei/hiar/ARHand$ARHandType;
...
.method public static valueOf(Ljava/lang/String;)Lcom/huawei/hiar/ARHand$ARHandType;
    ...
    check-cast p0, Lcom/huawei/hiar/ARHand$ARHandType;
...
.method public getKeyValues()I
    ...
    iget v0, p0, Lcom/huawei/hiar/ARHand$ARHandType;->nativeCode:I
