...
.method public constructor <init>(Lcom/google/common/util/concurrent/Service$State;ZLjava/lang/Throwable;)V
    ...
    :goto_4
    const-string/jumbo v1, "A failure cause should be set if and only if the state is failed.  Got %s and %s instead."
...
.method public failureCause()Ljava/lang/Throwable;
    ...
    .line 10
    :goto_0
    const-string/jumbo v2, "failureCause() is only valid if the service has failed, service is %s"
