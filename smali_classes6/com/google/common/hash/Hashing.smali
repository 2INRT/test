...
.method public static combineOrdered(Ljava/lang/Iterable;)Lcom/google/common/hash/HashCode;
    ...
    .line 9
    const-string/jumbo v2, "Must be at least 1 hash code to combine."
    ...
    .line 56
    :goto_0
    const-string/jumbo v5, "All hashcodes must have the same bit length."
...
.method public static concatenating(Ljava/lang/Iterable;)Lcom/google/common/hash/HashFunction;
    ...
    const-string/jumbo v1, "number of hash functions (%s) must be > 0"
...
.method public static consistentHash(JI)I
    ...
    .line 2
    :goto_0
    const-string/jumbo v2, "buckets must be positive: %s"
...
.method private static hmacToString(Ljava/lang/String;Ljava/security/Key;)Ljava/lang/String;
    ...
    .line 1
    const-string/jumbo v0, "Hashing."

    .line 2
    .line 3
    .line 4
    const-string/jumbo v1, "(Key[algorithm="
