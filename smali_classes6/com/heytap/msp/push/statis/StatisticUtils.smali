.class public Lcom/heytap/msp/push/statis/StatisticUtils;
...
.method public static statisticEvent(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 3
...
.method public static statisticEvent(Landroid/content/Context;Ljava/lang/String;Lcom/heytap/msp/push/mode/DataMessage;)Z
    .locals 11
...
.method public static statisticEvent(Landroid/content/Context;Ljava/util/List;)Z
    .locals 4
...
.method public static statisticEvent(Landroid/content/Context;Ljava/util/Map;)Z
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lcom/heytap/msp/push/mode/DataMessage;

    new-instance v15, Lcom/heytap/msp/push/mode/MessageStat;

    invoke-virtual {v1}, Lcom/heytap/msp/push/mode/DataMessage;->getMessageType()I

    move-result v2

    invoke-virtual {v1}, Lcom/heytap/msp/push/mode/DataMessage;->getGlobalId()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1}, Lcom/heytap/msp/push/mode/DataMessage;->getTaskID()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v1}, Lcom/heytap/msp/push/mode/DataMessage;->getStatisticsExtra()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v1}, Lcom/heytap/msp/push/mode/DataMessage;->getDataExtra()Ljava/lang/String;
    ...
    invoke-direct {v1, v10, v13}, Lcom/heytap/msp/push/mode/MessageStat;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v11}, Lcom/heytap/mcssdk/utils/StatUtil;->statisticMessage(Landroid/content/Context;Ljava/util/List;)Z
