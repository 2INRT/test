.class public Lcom/alibaba/security/realidentity/ui/webview/jsbridge/NativeCtidVerifyApi;
...
# static fields
.field private static final TAG:Ljava/lang/String; = "NativeCtidVerifyApi"
...
.method public execute(Ljava/lang/String;Lcom/alibaba/security/realidentity/ui/webview/jsbridge/JsCallbackAdapter;)Z
    ...
    .line 2
    .line 3
    const-string/jumbo v1, "NativeCtidVerifyApi execute params: "
    ...
    .line 16
    const-string/jumbo v1, "NativeCtidVerifyApi"
    ...
    .line 34
    new-instance v0, Lcom/alibaba/security/realidentity/ui/webview/jsbridge/NativeCtidVerifyApi$1;

    .line 35
    .line 36
    invoke-direct {v0, p0, p2}, Lcom/alibaba/security/realidentity/ui/webview/jsbridge/NativeCtidVerifyApi$1;-><init>(Lcom/alibaba/security/realidentity/ui/webview/jsbridge/NativeCtidVerifyApi;Lcom/alibaba/security/realidentity/ui/webview/jsbridge/JsCallbackAdapter;)V

    .line 37
    .line 38
    .line 39
    :try_start_1
    iget-object v2, p0, Lcom/alibaba/security/realidentity/ui/webview/jsbridge/BaseJsExecutor;->mContext:Landroid/content/Context;
    ...
    .line 44
    invoke-static {v2, p1, v3, v0}, Lcom/alibaba/security/realidentity/RPVerify;->startByCtidWithVerifyToken(Landroid/app/Activity;Ljava/lang/String;Lcom/alibaba/security/realidentity/RPConfig;Lcom/alibaba/security/realidentity/RPEventListener;)V
    :try_end_1
    ...
    .line 49
    const-string/jumbo v0, "Context cannot cast to Activity "
    ...
    .line 64
    const-string/jumbo v0, "NativeCtidVerifyApi parse params error"
...
.method public getTrackMethod()Ljava/lang/String;
    ...
    const-string/jumbo v0, "startByCtid"
