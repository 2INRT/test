.class Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatusDBHelper;
.super Lcom/alibaba/j256/ormlite/android/apptools/OrmLiteSqliteOpenHelper;
.source "SourceFile"


# static fields
.field private static final DB_NAME:Ljava/lang/String; = "permission_fortress_bizauthstatus"

.field private static final DB_VERSION_1:I = 0x1

.field private static final DB_VERSION_CURRENT:I = 0x1

.field private static final TAG:Ljava/lang/String; = "Fortress.AuthStatusDBHelper"


# instance fields
.field private mAuthStatusDao:Lcom/alibaba/j256/ormlite/dao/Dao;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p2}, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatusDBHelper;->getDbName(Ljava/lang/String;)Ljava/lang/String;
...
.method private static getDbName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1
    const-string/jumbo v0, "permission_fortress_bizauthstatus_"
...
.method public close()V
    ...
    .line 3
    :try_start_0
    iput-object v0, p0, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatusDBHelper;->mAuthStatusDao:Lcom/alibaba/j256/ormlite/dao/Dao;
...
.method public getAuthStatusDao()Lcom/alibaba/j256/ormlite/dao/Dao;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatusDBHelper;->mAuthStatusDao:Lcom/alibaba/j256/ormlite/dao/Dao;
    ...
    .line 5
    .line 6
    const-class v0, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatus;
...
.method public onCreate(Lcom/alibaba/sqlcrypto/sqlite/SQLiteDatabase;Lcom/alibaba/j256/ormlite/support/ConnectionSource;)V
    ...
    .line 7
    .line 8
    const-string/jumbo v1, "Fortress.AuthStatusDBHelper"
    ...
    .line 14
    :try_start_0
    const-class p1, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatus;
...
.method public onUpgrade(Lcom/alibaba/sqlcrypto/sqlite/SQLiteDatabase;Lcom/alibaba/j256/ormlite/support/ConnectionSource;II)V
    ...
    .line 53
    const-string/jumbo p4, "Fortress.AuthStatusDBHelper"
    ...
    .line 59
    :try_start_0
    const-class p3, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatus;
    ...
    .line 64
    .line 65
    invoke-virtual {p0, p1, p2}, Lcom/alipay/android/phone/mobilesdk/permission/fortress/auth/AuthStatusDBHelper;->onCreate(Lcom/alibaba/sqlcrypto/sqlite/SQLiteDatabase;Lcom/alibaba/j256/ormlite/support/ConnectionSource;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
