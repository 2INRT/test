...
.field private final mDataOnlyRemoteInputs:[Landroid/support/dontuse/app/RemoteInput;

.field final mExtras:Landroid/os/Bundle;

.field private final mRemoteInputs:[Landroid/support/dontuse/app/RemoteInput;
...
.method public constructor <init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroid/support/dontuse/app/RemoteInput;[Landroid/support/dontuse/app/RemoteInput;Z)V
    .locals 0
    ...
    .line 7
    iput-object p5, p0, Landroid/support/v4/app/NotificationCompat$Action;->mRemoteInputs:[Landroid/support/dontuse/app/RemoteInput;

    .line 8
    iput-object p6, p0, Landroid/support/v4/app/NotificationCompat$Action;->mDataOnlyRemoteInputs:[Landroid/support/dontuse/app/RemoteInput;
...
.method public getDataOnlyRemoteInputs()[Landroid/support/dontuse/app/RemoteInput;
    .locals 1

    .line 2
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Action;->mDataOnlyRemoteInputs:[Landroid/support/dontuse/app/RemoteInput;

    return-object v0
.end method

.method public bridge synthetic getDataOnlyRemoteInputs()[Landroid/support/dontuse/app/RemoteInputCompatBase$RemoteInput;
    .locals 1

    .line 1
    invoke-virtual {p0}, Landroid/support/v4/app/NotificationCompat$Action;->getDataOnlyRemoteInputs()[Landroid/support/dontuse/app/RemoteInput;
...
.method public getRemoteInputs()[Landroid/support/dontuse/app/RemoteInput;
    .locals 1

    .line 2
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Action;->mRemoteInputs:[Landroid/support/dontuse/app/RemoteInput;

    return-object v0
.end method

.method public bridge synthetic getRemoteInputs()[Landroid/support/dontuse/app/RemoteInputCompatBase$RemoteInput;
    .locals 1

    .line 1
    invoke-virtual {p0}, Landroid/support/v4/app/NotificationCompat$Action;->getRemoteInputs()[Landroid/support/dontuse/app/RemoteInput;
