...
.method public final a(Landroid/support/v7/widget/AdapterHelper$UpdateOp;)V
    ...
    .line 19
    :cond_0
    iget-object v0, v2, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/RecyclerView$LayoutManager;
    ...
    .line 36
    .line 37
    invoke-virtual {v0, v2, v1, v3, p1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->onItemsUpdated(Landroid/support/v7/widget/RecyclerView;IILjava/lang/Object;)V
    ...
    .line 46
    .line 47
    invoke-virtual {v0, v2, v1, p1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->onItemsRemoved(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 56
    .line 57
    invoke-virtual {v0, v2, v1, p1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->onItemsAdded(Landroid/support/v7/widget/RecyclerView;II)V
...
.method public final markViewHoldersUpdated(IILjava/lang/Object;)V
    ...
    .line 7
    iput-boolean p1, v0, Landroid/support/v7/widget/RecyclerView;->mItemsChanged:Z
...
.method public final offsetPositionsForAdd(II)V
    ...
    .line 7
    iput-boolean p1, v0, Landroid/support/v7/widget/RecyclerView;->mItemsAddedOrRemoved:Z
...
.method public final offsetPositionsForRemovingInvisible(II)V
    ...
    .line 8
    .line 9
    iget-object p1, v0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$State;

    .line 10
    .line 11
    iget v0, p1, Landroid/support/v7/widget/RecyclerView$State;->e:I
    ...
    .line 14
    iput v0, p1, Landroid/support/v7/widget/RecyclerView$State;->e:I
...
.method public final offsetPositionsForRemovingLaidOutOrNewView(II)V
    ...
    .line 3
    .line 4
    invoke-virtual {v1, p1, p2, v0}, Landroid/support/v7/widget/RecyclerView;->offsetPositionRecordsForRemove(IIZ)V
    ...
    .line 8
    iput-boolean p1, v1, Landroid/support/v7/widget/RecyclerView;->mItemsAddedOrRemoved:Z
...
.method public final onDispatchFirstPass(Landroid/support/v7/widget/AdapterHelper$UpdateOp;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/RecyclerView$6;->a(Landroid/support/v7/widget/AdapterHelper$UpdateOp;)V
