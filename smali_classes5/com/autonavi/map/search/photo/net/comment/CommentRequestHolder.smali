.class public Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
...
# static fields
.field private static volatile instance:Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
...
.method public static getInstance()Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
    .locals 2

    .line 1
    sget-object v0, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;->instance:Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
    ...
    .line 4
    .line 5
    const-class v0, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
    ...
    .line 8
    :try_start_0
    sget-object v1, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;->instance:Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
    ...
    .line 11
    .line 12
    new-instance v1, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;

    .line 13
    .line 14
    invoke-direct {v1}, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;-><init>()V

    .line 15
    .line 16
    .line 17
    sput-object v1, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;->instance:Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;
...
.method public sendImgUpload(Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;Lcom/amap/bundle/aosservice/response/AosResponseCallback;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0, p2}, Lcom/autonavi/map/search/photo/net/comment/CommentRequestHolder;->sendImgUpload(Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;Lcom/autonavi/minimap/falcon/base/a;Lcom/amap/bundle/aosservice/response/AosResponseCallback;)V

    return-void
.end method

.method public sendImgUpload(Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;Lcom/autonavi/minimap/falcon/base/a;Lcom/amap/bundle/aosservice/response/AosResponseCallback;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    :cond_0
    sget-object v0, Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;->l:Ljava/lang/String;
    ...
    .line 10
    iget-object v1, p1, Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;->g:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Lcom/amap/bundle/aosservice/request/AosRequest;->addReqParam(Ljava/lang/String;Ljava/lang/String;)V

    .line 11
    iget-object v0, p1, Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;->h:Ljava/io/File;

    const-string/jumbo v1, "picture"

    .line 12
    invoke-virtual {p1, v0, v1}, Lcom/amap/bundle/aosservice/request/AosMultipartRequest;->a(Ljava/io/File;Ljava/lang/String;)V

    const-string/jumbo v0, "checksum"

    iget-object v1, p1, Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;->i:Ljava/lang/String;
    ...
    .line 14
    iget-object v1, p1, Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;->j:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Lcom/amap/bundle/aosservice/request/AosRequest;->addReqParam(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v0, "poi_y"

    iget-object v1, p1, Lcom/autonavi/map/search/photo/net/comment/param/ImgUploadRequest;->k:Ljava/lang/String;
